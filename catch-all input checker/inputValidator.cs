...
namespace inputChecker
{
    class validator
    {
        //to be used as a helpful "plug-and-play" tool when writing other code
        public static object strInputValidator(object input, string critera)
        {
            bool[] passer = new bool[5] { true, true, true, true, true };
            string inAsString = "";
            if (input is null)
            {
                passer[0] = false;
